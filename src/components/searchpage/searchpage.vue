<template>
    <transition name="move">
        <div class="searchpage">
            <div class="header">
                <input type="text" placeholder="影视 图书等" @keyup.enter="gosacshow" ref="getvalue">
...
<script type="text/ecmascript-6">
    export default {
        ...
        methods:{
            ...
            //按回车键后跳转到搜索页面
            gosacshow() {
                let vauledata =this.$refs.getvalue.value;
                this.$router.push({ path: 'searchshow', query: { q: vauledata }});
